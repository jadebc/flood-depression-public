...
res <- data.frame(
  bind_rows(res_epds_floodc_unadj, res_epds_floodu_unadj, res_dep_floodc_unadj, res_dep_floodu_unadj,
            res_epds_floodc_adj, res_epds_floodu_adj, res_dep_floodc_adj, res_dep_floodu_adj)
)

saveRDS(res, paste0(here::here(), "/data/flooding_regression_results.RDS"))
